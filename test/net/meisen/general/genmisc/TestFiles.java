...
public class TestFiles {
    ...
    public static final class Util {
         ...
         *
         * @param resource the location of the resource to be unzipped on the
         *                 classpath
         ...
         *
         * @param tmpTestDir the directory to be validated
         * @throws IOException if the a file cannot be validated
         */
     ...
     *
     * @throws IOException if a <code>File</code> for testing cannot be created
     */
    @Test
     ...
     *
     * @throws IOException if the test-files could not be created
     */
    @Test
     ...
     *
     * @throws IOException if the specified test file cannot be read
     */
    @Test
     ...
     *
     * @throws IOException if the test-files cannot be created or read
     ...
     *
     * @throws IOException if the test-file could not be created
     */
    @Test
     ...
     *
     * @throws IOException if the zip cannot be read or unzipped
     */
    @Test
