...
public class TestExceptionCatalog {
	...
	public void testEmptyCatalog() {
		assertEquals(0, new DefaultExceptionCatalog().size());
	}
	...
	public void testCreationByProperties() throws InvalidCatalogEntryException {
		...
		final DefaultExceptionCatalog catalog = new DefaultExceptionCatalog(properties);
	...
	public void testCreationByEntries() {
		final DefaultExceptionCatalog catalog = new DefaultExceptionCatalog(new CatalogEntry(1000, "Invalid User"),
				new CatalogEntry(1001, "Invalid Password"));
	...
	public void testCreationByUTF8Stream() throws InvalidCatalogEntryException {
		final InputStream stream = getClass().getResourceAsStream("catalog-test-UTF8.properties");
